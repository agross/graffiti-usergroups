...
namespace DnugLeipzig.Plugins.Tests.HttpMocks
{
	[TestFixture]
	public class HttpSimulatorTests
	{
		...
		[RowTest]
		[Row("http://localhost/Test/default.aspx", "/Test", @"c:\projects\test", @"c:\projects\test\",
			@"c:\projects\test\default.aspx")]
		[Row("http://localhost/Test/Subtest/default.aspx", "/Test", @"c:\projects\test", @"c:\projects\test\",
			@"c:\projects\test\Subtest\default.aspx")]
		[Row("http://localhost/test/default.aspx", "/", @"c:\inetpub\wwwroot\", @"c:\inetpub\wwwroot\",
			@"c:\inetpub\wwwroot\test\default.aspx")]
		[Row("http://localhost/test/default.aspx", "/", @"c:\inetpub\wwwroot", @"c:\inetpub\wwwroot\",
			@"c:\inetpub\wwwroot\test\default.aspx")]
		...
		[Row("http://localhost:60653/Test.aspx?test=true", null, null, "localhost", 60653, "/", "/Test.aspx",
			@"c:\InetPub\wwwRoot\")]
		[Row("http://localhost:60653/Test.aspx", "/", @"c:\InetPub\wwwRoot\", "localhost", 60653, "/", "/Test.aspx",
			@"c:\InetPub\wwwRoot\")]
		[Row("http://localhost:60653/Test/Test.aspx", "/", @"c:\InetPub\wwwRoot\", "localhost", 60653, "/", "/Test/Test.aspx",
			@"c:\InetPub\wwwRoot\")]
		[Row("http://localhost:60653/AppPath/Test.aspx", "/AppPath", @"c:\InetPub\wwwRoot\AppPath\", "localhost", 60653,
			"/AppPath", "/AppPath/Test.aspx", @"c:\InetPub\wwwRoot\AppPath\")]
		[Row("http://localhost:60653/AppPath/Test.aspx", "/AppPath/", @"c:\InetPub\wwwRoot\AppPath\", "localhost", 60653,
			"/AppPath", "/AppPath/Test.aspx", @"c:\InetPub\wwwRoot\AppPath\")]
		...
		public void CanInstantiateVirtualPath()
		{
			Type virtualPathType =
				Type.GetType(
					"System.Web.VirtualPath, System.Web, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", true);
			ConstructorInfo constructor = virtualPathType.GetConstructor(BindingFlags.NonPublic | BindingFlags.Instance,
			                                                             null,
			                                                             new[] { typeof(string) },
			                                                             null);
		...
		#region Nested type: TestHttpHandler
